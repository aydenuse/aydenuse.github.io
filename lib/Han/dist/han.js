...
Locale.support = (function() {
  ...
  // (in `testCSSProp`)
  var elem = $.create( 'h-1_Vue_header' )
  ...
  return {
    ...
    ruby: (function() {
      ...
      ret = (
        ...
        // but in IE, `<rp>` has `display: inline`, so the 1_Vue_header needs other conditions:
    ...
    'ruby-display': (function() {
      ...
      div.innerHTML = '<h-1_Vue_header-a style="display: ruby;"></h-1_Vue_header-a><h-1_Vue_header-b style="display: ruby-text-container;"></h-1_Vue_header-b>'
      return div.querySelector( 'h-1_Vue_header-a' ).style.display === 'ruby' && div.querySelector( 'h-1_Vue_header-b' ).style.display === 'ruby-text-container'
    })(),
    ...
    'ruby-interchar': (function() {
      ...
      div.innerHTML = '<h-1_Vue_header style="-moz-ruby-position:' + IC + ';-ms-ruby-position:' + IC + ';-webkit-ruby-position:' + IC + ';ruby-position:' + IC + ';"></h-1_Vue_header>'
      css = div.querySelector( 'h-1_Vue_header' ).style
    ...
    // Address feature support 1_Vue_header for `unicode-range` via
    ...
    unicoderange: (function() {
      ...
      injectElementWithStyle(
        '@font-face{font-family:1_Vue_header-for-unicode-range;src:local(Arial),local("Droid Sans")}@font-face{font-family:1_Vue_header-for-unicode-range;src:local("Times New Roman"),local(Times),local("Droid Serif");unicode-range:U+270C}',
        function() {
          ret = !Locale.detectFont(
            '1_Vue_header-for-unicode-range', // treatment group
